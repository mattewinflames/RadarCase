                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                  ...
                  <div className="text-left md:text-right">
                    ...
                    <div className="bg-amber-600 px-6 py-3 rounded-2xl shadow-xl shadow-amber-900/40">
                      <p className="text-[9px] text-amber-100 uppercase font-bold tracking-widest mb-0.5 whitespace-nowrap">Annuo (canone + extra × 12)</p>
                      <p className="text-2xl font-bold text-white font-mono leading-none">
                        € {calcs.yearlyRecurring.toLocaleString('it-IT')}
                      </p>
                      <p className="text-[9px] text-amber-200 mt-1 font-mono">€ {calcs.monthlyRecurring.toLocaleString('it-IT')} / mese</p>
                    </div>
                  </div>
                </div>
