...
export default function AddHouseModal({ onAdd, isOpen, onClose, appMode }: Props) {
  const [formData, setFormData] = useState({
    ...
    buildingFloors: '' as string | number,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.buildingFloors !== '') finalFormData.buildingFloors = Number(formData.buildingFloors);
    else delete finalFormData.buildingFloors;
